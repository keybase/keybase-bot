            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        conv = this.getChannelOrConversationId(channelOrConversationId);
                        args = __assign(__assign(__assign(__assign({}, options), { explodingLifetime: options.explodingLifetime ? options.explodingLifetime + "ms" : undefined }), conv), { message: message });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        conv = this.getChannelOrConversationId(channelOrConversationId);
                        args = __assign(__assign(__assign(__assign({}, options), { explodingLifetime: options.explodingLifetime ? options.explodingLifetime + "ms" : undefined }), conv), { filename: filename });
