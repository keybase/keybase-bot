...
var Chat = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        optionsWithDefaults = __assign(__assign({}, options), { channel: channel, peek: options && options.peek ? options.peek : false, unreadOnly: options && options.unreadOnly !== undefined ? options.unreadOnly : false });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        args = __assign(__assign({}, options), { channel: channel,
                            message: message });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        args = __assign(__assign({}, options), { channel: channel, filename: filename });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        args = __assign(__assign({}, options), { channel: channel, messageId: messageId, output: output });
    ...
    Chat.prototype._chatListenConvs = function (onConv, onError) {
        ...
        this._spawnChatListenChild(args, function (line) {
            _this._adminDebugLogger.info("stdout from listener: " + line);
            try {
                var messageObject = utils_1.formatAPIObjectOutput(JSON.parse(line));
                if (messageObject.hasOwnProperty('error')) {
