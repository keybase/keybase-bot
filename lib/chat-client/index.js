...
var Chat = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        conv = this.getChannelOrConversationId(channelOrConversationId);
                        args = __assign(__assign(__assign(__assign({}, options), { explodingLifetime: ((_a = options) === null || _a === void 0 ? void 0 : _a.explodingLifetime) ? options.explodingLifetime + "ms" : undefined }), conv), { message: message });
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        conv = this.getChannelOrConversationId(channelOrConversationId);
                        args = __assign(__assign(__assign(__assign({}, options), { explodingLifetime: ((_a = options) === null || _a === void 0 ? void 0 : _a.explodingLifetime) ? options.explodingLifetime + "ms" : undefined }), conv), { filename: filename });
    ...
    Chat.prototype._chatListenMessage = function (onMessage, onError, channel, options) {
        ...
        var onLine = function (line) {
            ...
            try {
                var messageObject = utils_1.formatAPIObjectOutput(JSON.parse(line), null);
