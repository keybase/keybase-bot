...
const Chat = /** @class */ (function(_super) {
  ...
  Chat.prototype.list = function(options) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this._guardInitialized()]
          case 1:
            _a.sent()
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            _a.sent()
            optionsWithDefaults = __assign({}, options, {
              name: name,
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this._runApiCommand({apiName: 'chat', method: 'read', options: optionsWithDefaults}),
            ]
          case 2:
            res = _a.sent()
            if (!res) {
            ...
            return [
              2 /*return*/,
              {
                ...
                messages: res.messages.map(function(message) {
                  return message.msg
                }),
              },
            ]
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            _a.sent()
            args = __assign({}, options, {channel: channel, message: message})
            return [
              4 /*yield*/,
              this._runApiCommand({
                apiName: 'chat',
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            _a.sent()
            args = __assign({}, options, {channel: channel, messageId: messageId, message: {body: reaction}})
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            _a.sent()
            args = __assign({}, options, {channel: channel, messageId: messageId})
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this._runApiCommand({apiName: 'chat', method: 'getunfurlsettings', options: {}}),
            ]
          case 2:
            res = _a.sent()
            if (!res) {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this._runApiCommand({apiName: 'chat', method: 'setunfurlsettings', options: mode}),
            ]
          case 2:
            res = _a.sent()
            if (!res) {
  ...
  Chat.prototype._chatListen = function(onMessage, onError, channel, options) {
    ...
    const child = child_process_1.spawn(this._pathToKeybaseBinary(), args)
    ...
    const onLine = function(line) {
      try {
        const messageObject = utils_1.formatAPIObjectOutput(JSON.parse(line))
        if (messageObject.hasOwnProperty('error')) {
          ...
          (_this.username &&
            _this.devicename &&
            (messageObject.msg.sender.username !== _this.username.toLowerCase() ||
              messageObject.msg.sender.deviceName !== _this.devicename))
        ) {
