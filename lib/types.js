 ...
 * With Store
 */
export type WithStoreInit = (store: Store) => Init

export type WithStoreDeinit = (store: Store) => Deinit

export type WithStoreMyInfo = (store: Store) => MyInfo

export type WithStoreList = (store: Store) => List

export type WithStoreRead = (store: Store) => Read

export type WithStoreSend = (store: Store) => Send

export type WithStoreDelete = (store: Store) => Delete

export type WithStoreWatchChannelForNewMessage = (store: Store) => WatchChannelForNewMessage

export type WithStoreWatchAllChannelsForNewMessages = (store: Store) => WatchAllChannelsForNewMessages

export type AnyApiWithStore =
  | WithStoreMyInfo
  | WithStoreDeinit
  | WithStoreMyInfo
  | WithStoreList
  ...
  | WithStoreSend
  | WithStoreDelete
  | WithStoreWatchChannelForNewMessage
  | WithStoreWatchAllChannelsForNewMessages
