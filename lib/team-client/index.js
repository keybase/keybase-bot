...
const Team = /** @class */ (function(_super) {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this._runApiCommand({apiName: 'team', method: 'add-members', options: options}),
            ]
          case 2:
            res = _a.sent()
            if (!res) {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this._runApiCommand({apiName: 'team', method: 'remove-member', options: options}),
            ]
          case 2:
            res = _a.sent()
            return [2 /*return*/, res]
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this._runApiCommand({apiName: 'team', method: 'list-team-memberships', options: options}),
            ]
          case 2:
            res = _a.sent()
            if (!res) {
