...
function rmdirRecursive(dirName) {
    return __awaiter(this, void 0, void 0, function () {
        var fsLstat, fsUnlink, fsRmdir, fsReaddir, dirStat, _i, _a, entry, entryPath, stat;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 5:
                    _b.sent();
                    return [3 /*break*/, 8];
                case 6: return [4 /*yield*/, fsUnlink(entryPath)];
                case 7:
                    _b.sent();
                    _b.label = 8;
                case 8:
                    _i++;
                    return [3 /*break*/, 3];
                case 9: return [4 /*yield*/, fsRmdir(dirName)];
                case 10:
                    _b.sent();
                    _b.label = 11;
