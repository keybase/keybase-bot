...
function formatAPIObjectInput(obj, apiType) {
  if (obj === null || obj === undefined || typeof obj !== 'object') {
    ...
    return obj.map(function(item) {
      return formatAPIObjectInput(item, apiType)
    })
  } else {
    return Object.keys(obj).reduce(function(newObj, key) {
      ...
      if (typeof obj[key] === 'object') {
        return __assign(
          {},
          newObj,
          ((_a = {}), (_a[formattedKey] = formatAPIObjectInput(obj[key], apiType)), _a)
        )
      }
      return __assign({}, newObj, ((_b = {}), (_b[formattedKey] = obj[key]), _b))
    }, {})
  }
}
...
function matchBlacklist(context) {
  ...
  for (let _i = 0, _a = transformsBlacklist[context.apiName][context.method]; _i < _a.length; _i++) {
    const matcher = _a[_i]
    ...
    let mismatch = false
    for (let _b = 0, _c = matcher.entries(); _b < _c.length; _b++) {
      const _d = _c[_b],
        matcherIndex = _d[0],
        desiredValue = _d[1]
...
function buildContext(context, key) {
  ...
  const copiedContext = __assign({}, context)
...
function formatAPIObjectOutput(obj, context) {
  if (obj == null || typeof obj !== 'object') {
    ...
    return obj.map(function(item, i) {
      return formatAPIObjectOutput(item, buildContext(context, i))
    })
  } else {
    return Object.keys(obj).reduce(function(newObj, key) {
      let _a, _b
      const formattedKey = matchBlacklist(context) ? key : lodash_camelcase_1.default(key)
      if (typeof obj[key] === 'object') {
        return __assign(
          {},
          newObj,
          ((_a = {}), (_a[formattedKey] = formatAPIObjectOutput(obj[key], buildContext(context, key))), _a)
        )
      }
      return __assign({}, newObj, ((_b = {}), (_b[formattedKey] = obj[key]), _b))
    }, {})
