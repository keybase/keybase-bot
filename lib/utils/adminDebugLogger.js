    ...
    AdminDebugLogger.prototype._logIt = function (text, code) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.directory && this.filename)) return [3 /*break*/, 2];
    ...
    AdminDebugLogger.prototype._copyLoop = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this._deinitYet) return [3 /*break*/, 7];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        if (!(this.directory && this._botServiceLogPath)) return [3 /*break*/, 3];
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 5];
                    case 5: return [4 /*yield*/, index_1.timeout(900)];
                    case 6:
                        _a.sent();
                        return [3 /*break*/, 0];
