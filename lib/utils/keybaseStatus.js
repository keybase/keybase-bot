 ...
 */
function keybaseStatus(workingDir, homeDir) {
    return __awaiter(this, void 0, void 0, function () {
        var status;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, keybaseExec_1.default(workingDir, homeDir, ['status', '--json'], { json: true })];
                case 1:
                    status = _a.sent();
...
exports.default = keybaseStatus;
//# sourceMappingURL=keybaseStatus.js.map