...
var aWhich = util_1.promisify(which_1.default);
/**
...
function whichKeybase() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, aWhich(keybaseBinaryName_1.default)];
                case 1:
                    path = _a.sent();
                    if (!path) {
...
exports.default = whichKeybase;
//# sourceMappingURL=whichKeybase.js.map