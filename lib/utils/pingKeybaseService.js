...
var keybaseExec_1 = __importDefault(require("../utils/keybaseExec"));
/**
 ...
 */
function pingKeybaseService(workingDir, homeDir) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, keybaseExec_1.default(workingDir, homeDir, ['--no-auto-fork', 'status', '--json'], { json: true })];
                case 1:
                    _a.sent();
...
exports.default = pingKeybaseService;
//# sourceMappingURL=pingKeybaseService.js.map