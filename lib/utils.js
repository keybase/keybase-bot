...
//
export function keybaseServiceStartup(tempDir: string): Promise<void> {
  const child = spawn('keybase', ['--home', tempDir, 'service'])
...
export const keybaseExec = (
  ...
  const runArgs: string[] = ['--home', tempDir].concat(args)
