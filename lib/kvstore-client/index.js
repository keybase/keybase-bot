        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        options = { namespace: namespace, team: team };
                        return [4 /*yield*/, this._runApiCommand({ apiName: 'kvstore', method: 'list', options: options })];
                    case 2:
                        res = _a.sent();
                        if (!res) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        options = { entrykey: entryKey, namespace: namespace, team: team };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        options = { entrykey: entryKey, entryvalue: entryValue, namespace: namespace, revision: revision, team: team };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        options = { entrykey: entryKey, namespace: namespace, revision: revision, team: team };
