...
var Wallet = /** @class */ (function (_super) {
     ...
     */
    Wallet.prototype.watchForNewTransactions = function (onTransaction, onError) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._guardInitialized()];
     ...
     * this._transactionListen(onTransaction, onError)
     */
    Wallet.prototype._transactionListen = function (onTransaction, onError) {
        var _this = this;
        ...
        var onLine = function (line) {
            ...
            try {
                var transactionNotification = utils_1.formatAPIObjectOutput(JSON.parse(line));
