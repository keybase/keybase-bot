...
const Wallet = /** @class */ (function(_super) {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this._runApiCommand({apiName: 'wallet', method: 'history', options: options}),
            ]
          case 2:
            res = _a.sent()
            if (!res) {
            ...
            cleanedRes = res.map(function(historyItem) {
              return historyItem.payment
            })
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [
              4 /*yield*/,
              this._runApiCommand({apiName: 'wallet', method: 'details', options: options}),
            ]
          case 2:
            res = _a.sent()
            if (!res) {
   ...
   */
  Wallet.prototype.batch = function(batchId, payments) {
    return __awaiter(this, void 0, void 0, function() {
      let options, res
      return __generator(this, function(_a) {
        switch (_a.label) {
