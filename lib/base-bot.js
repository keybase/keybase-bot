 ...
 *
 */
export const guardInitialized = async (store: Store, fn: Function): Promise<void | Function> => {
...
export const init = (store: Store) => {
   ...
   *
   */
  return async (options: InitOptions): Promise<void> => {
    try {
 ...
 */
export const myInfo = (): ?DeviceUsernamePair => {
