...
const safeJSONStringify_1 = __importDefault(require('../utils/safeJSONStringify'))
 ...
 * @ignore
 */
const ClientBase = /** @class */ (function() {
  function ClientBase(workingDir) {
  ...
  ClientBase.prototype._init = function(homeDir, options) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, utils_1.keybaseStatus(this._workingDir, homeDir)]
          case 1:
            initBotInfo = _a.sent()
  ...
  ClientBase.prototype._deinit = function() {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_b) {
        for (_i = 0, _a = this.spawnedProcesses; _i < _a.length; _i++) {
          child = _a[_i]
          child.kill()
        }
        return [2 /*return*/]
  ...
  ClientBase.prototype._runApiCommand = function(arg) {
    return __awaiter(this, void 0, void 0, function() {
      let options, input, inputString, size, output, res
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            return [
              4 /*yield*/,
              utils_1.keybaseExec(this._workingDir, this.homeDir, [arg.apiName, 'api'], {
  ...
  ClientBase.prototype._pathToKeybaseBinary = function() {
    return path_1.default.join(this._workingDir, 'keybase')
  }
  return ClientBase
})()
