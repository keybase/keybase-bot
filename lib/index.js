...
var Bot = /** @class */ (function () {
    ...
    function Bot(opts) {
        ...
        this._service = new service_1.default(this._workingDir, this._adminDebugLogger, (debugLogging !== null && debugLogging !== void 0 ? debugLogging : false));
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        _c.sent();
                        return [4 /*yield*/, this._initSubBots()];
                    case 3:
                        _c.sent();
                        if (!(options && options.adminDebugDirectory && this._service.serviceLogFile)) return [3 /*break*/, 5];
                        return [4 /*yield*/, ((_a = this._adminDebugLogger) === null || _a === void 0 ? void 0 : _a.init(options.adminDebugDirectory, this._service.serviceLogFile))];
                    case 4:
                        _c.sent();
                        _c.label = 5;
                    case 5:
                        this._initStatus = 'initialized';
                        (_b = this._adminDebugLogger) === null || _b === void 0 ? void 0 : _b.info('initialized');
                        return [2 /*return*/];
                }
            });
        });
    ...
    Bot.prototype._beginInitState = function () {
        ...
        (_a = this._adminDebugLogger) === null || _a === void 0 ? void 0 : _a.info('beginning initialization');
    };
    /**
    ...
    Bot.prototype.myInfo = function () {
        var _a;
        return _a = this._service.myInfo(), (_a !== null && _a !== void 0 ? _a : null);
    };
    /**
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        (_a = this._adminDebugLogger) === null || _a === void 0 ? void 0 : _a.info('Trying to deinitialize, but already called');
                        return [3 /*break*/, 5];
                    case 1:
                        this._initStatus = 'deinitializing';
                        (_b = this._adminDebugLogger) === null || _b === void 0 ? void 0 : _b.info('beginning deinit');
                    ...
                    case 4:
                        _e.sent();
                        (_c = this._adminDebugLogger) === null || _c === void 0 ? void 0 : _c.info('finished deinit');
                        (_d = this._adminDebugLogger) === null || _d === void 0 ? void 0 : _d.deinit();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        myInfo = this.myInfo();
                        if (!myInfo)
                            throw new Error("can't run pprof without a homedir");
                        return [4 /*yield*/, Utils.keybaseExec(this._workingDir, myInfo.homeDir, __spreadArrays([
                                'pprof',
                                pprofType
    ...
    Bot.prototype._initSubBots = function () {
        return __awaiter(this, void 0, void 0, function () {
            var info;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.chat._init(info.homeDir)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.wallet._init(info.homeDir)];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.team._init(info.homeDir)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.helpers._init(info.homeDir)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, this.kvstore._init(info.homeDir)];
                    case 5:
                        _a.sent();
                        return [3 /*break*/, 7];
