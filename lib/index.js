...
const chat_client_1 = __importDefault(require('./chat-client'))
const wallet_client_1 = __importDefault(require('./wallet-client'))
const team_client_1 = __importDefault(require('./team-client'))
...
const Bot = /** @class */ (function() {
   ...
   */
  function Bot() {
    this._workingDir = utils_1.randomTempDir()
    this._service = new service_1.default(this._workingDir)
    this.chat = new chat_client_1.default(this._workingDir)
    this.wallet = new wallet_client_1.default(this._workingDir)
    this.team = new team_client_1.default(this._workingDir)
  }
  /**
  ...
  Bot.prototype._prepWorkingDir = function() {
    return __awaiter(this, void 0, void 0, function() {
      let keybaseBinaryLocation, destination
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
