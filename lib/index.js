            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, utils_2.keybaseExec(this._workingDir, this.myInfo().homeDir, __spreadArrays([
                                'pprof',
                                pprofType
                    ...
                    case 1:
                        _a.sent();
                        // The call above is asynchronous. So jsut wait for 2 more seconds.
                        return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(function () { return resolve(); }, sec * 1000 + 2000); })];
                    case 2:
                        // The call above is asynchronous. So jsut wait for 2 more seconds.
                        _a.sent();
