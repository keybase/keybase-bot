...
const Service = /** @class */ (function() {
  function Service(workingDir) {
  ...
  Service.prototype.init = function(username, paperkey, options) {
    return __awaiter(this, void 0, void 0, function() {
      let currentInfo, err_1
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            if (!username || typeof username !== 'string') {
              throw new Error(
                'Please provide a username to initialize the bot. Got: ' + JSON.stringify(username)
              )
            }
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              utils_1.keybaseExec(this.workingDir, this.homeDir, ['oneshot', '--username', username], {
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              utils_1.keybaseExec(this.workingDir, this.homeDir, [
                'chat',
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            _a.trys.push([0, 2, , 3])
            return [4 /*yield*/, utils_1.keybaseExec(this.workingDir, this.homeDir, ['logout'])]
          case 1:
            _a.sent()
            return [3 /*break*/, 3]
          case 2:
          ...
          case 3:
            ...
            return [
              4 /*yield*/,
              utils_1.keybaseExec(this.workingDir, this.homeDir, ['ctl', 'stop', '--shutdown']),
            ]
          case 4:
            _a.sent()
            return [3 /*break*/, 6]
  ...
  Service.prototype.startupService = function() {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        ...
        child = child_process_1.spawn(path_1.default.join(this.workingDir, 'keybase'), args, {
          env: process.env,
        })
                ...
                switch (_a.label) {
                  case 0:
                    child.on('close', function(code) {
                      ...
                      reject(
                        new Error('keybase service exited with code ' + code + ' (' + _this.workingDir + ')')
                      )
                    })
                    i = 0
                    _a.label = 1
                  case 1:
                    return [4 /*yield*/, utils_1.pingKeybaseService(this.workingDir, this.homeDir)]
                  case 2:
  ...
  Service.prototype.logSend = function() {
    return __awaiter(this, void 0, void 0, function() {
      let initiallyRunning, e_3, feedback, args
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
          ...
          case 2:
            ...
            return [
              4 /*yield*/,
              utils_1.keybaseExec(this.workingDir, this.homeDir, ['oneshot', '--username', this.username], {
