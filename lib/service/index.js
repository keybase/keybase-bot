...
var Service = /** @class */ (function () {
    function Service(workingDir, adminDebugLogger) {
    ...
    Service.prototype.startupService = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                child = child_process_1.spawn(path_1.default.join(this.workingDir, 'keybase'), args, { env: process.env, detached: this._useDetachedService });
